...
// .toString() joins the characters into a new string. The characters are joined at the element specified in the parentheses. 
console.log(myString.toString('')); //In this case, the characters are an empty string. Logs dog
